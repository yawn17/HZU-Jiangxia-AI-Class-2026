...
​				![image-20260221124124570](C:\Users\刘波锐\AppData\Roaming\Typora\typora-user-images\image-20260221124124570.png)
...
![image-20260221124208067](C:\Users\刘波锐\AppData\Roaming\Typora\typora-user-images\image-20260221124208067.png)

> - 所谓的多头self-attention层, 则是先将Q, K, V经过参数矩阵进行映射, 再做self-attention, 最后将结果拼接起来送入一个全连接层即可.

![image-20260221124230275](C:\Users\刘波锐\AppData\Roaming\Typora\typora-user-images\image-20260221124230275.png)
...
![image-20260221124245431](C:\Users\刘波锐\AppData\Roaming\Typora\typora-user-images\image-20260221124245431.png)
...
- 前馈全连接层模块
  ...
  - 前馈全连接层模块, 由两个线性变换组成, 中间有一个Relu激活函数, 对应的数学公式形式如下:
    ...
    ​		![image-20260221124309741](C:\Users\刘波锐\AppData\Roaming\Typora\typora-user-images\image-20260221124309741.png)
...
- Transformer中直接采用正弦函数和余弦函数来编码位置信息, 如下图所示:
  ...
  ![image-20260221124359428](C:\Users\刘波锐\AppData\Roaming\Typora\typora-user-images\image-20260221124359428.png)

- 需要注意: 三角函数应用在此处的一个重要的优点, 因为对于任意的PE(pos+k), 都可以表示为PE(pos)的线性函数, 大大方便计算. 而且周期性函数不受序列长度的限制, 也可以增强模型的泛化能力.

  ![image-20260221124420239](C:\Users\刘波锐\AppData\Roaming\Typora\typora-user-images\image-20260221124420239.png)
